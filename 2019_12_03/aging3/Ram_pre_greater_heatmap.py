...
from net3_model_RAM_greater_heatmap import generate_model
...
while(True):
    ...
    heatmap = ndimage.zoom(RAM, (3.95, 3.9583333333333335, 3.95))
...
np.save('ctr_heatmap.npy',ctr_heatmap)
np.save('mig_heatmap.npy',mig_heatmap)
np.save('dif_heatmap.npy',dif_heatmap)
np.save('aver_heatmap.npy',average_hm)
